            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <div>
                  <Link 
                  to="/admin/product-form-page"
                  className="rounded-md mx-10 bg-green-600 p-2 mt-2 text-sm font-semibold text-white">
                  Add New Product
                </Link>
                  </div>
            ...
            {products.map((product) => (
              <div>
                <Link to={`product-detail/${product.id}`}>
                  <div
                    key={product.id}
                    className="group relative border_solid border-2 p-2"
                  >
                ...
                <div  className="mt-5">
                <Link 
                to={`/admin/product-form-page/edit/${product.id}`}
