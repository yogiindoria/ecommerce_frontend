...
function Checkout() {
  ...
  console.log(user,"user from checkoutpage");
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ">
          <div className="lg:col-span-3">
            <form 
              className="bg-white px-5 py-4 my-10"
              noValidate
              onSubmit={(async (e) => {
                e.preventDefault();
                ...
                dispatch(
                  updateUserAsync({
                    ...user,
                    addresses: [...user.addresses, addAddress],
                  })
                );
                // reset();
              })}
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-10 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-4xl font-bold tracking-tight py-4 text-gray-900">
                Cart
              </h1>
